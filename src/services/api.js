import {  mockUsers,USER_LIST_MOCK, USER_PROFILE_MOCK, VENDOR_PROFILE_MOCK, EMPLOYEE_PROFILE_MOCK,
          ...
          VENDOR_PROFILE_HISTORY_MOCK,VENDOR_PROFILE_DOCUMENTS_MOCK,GLOBAL_INVENTORY_MOCK,GLOBAL_DOCUMENTS_MOCK,
          EMPLOYEE_LIST_MOCK,
...
export const vendorApi = {
  ...
  async getGlobalInventory(){
    return Promise.resolve(GLOBAL_INVENTORY_MOCK);
  },
  async getGlobalDocuments(){
    return Promise.resolve(GLOBAL_DOCUMENTS_MOCK);
  }
}
...
export const profileApi = {
  ...
  async getVendorsProfileAdminsById(id) {
    const res = VENDOR_PROFILE_ADMINS_MOCK.find(a=>a.id === id);
    return Promise.resolve(res);
  },
  async getVendorProfileInventoryById(id) {
