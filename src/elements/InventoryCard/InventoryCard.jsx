...
export default function InventoryCard({ product, onEdit, onDelete, onViewDetails }) {
    ...
    const getPricePeriod = () => {
        switch (serviceCategory) {
            case 'accommodation': return lang('inventoryCard.pricePer.accommodation');
            case 'carRental': return lang('inventoryCard.pricePer.carRental');
            case 'entertainment': return lang('inventoryCard.pricePer.entertainment');
            default: return lang('inventoryCard.pricePer.restaurant');
        }
    };

    return (
        <div className={`inventory-card ${!isActive ? 'inactive' : ''} ${isOutOfStock ? 'out-of-stock' : ''}`}>
            ...
            <div className="card-content">
                ...
                <div className="card-price">
                    ...
                    <span className="price-period">
                        {lang('inventoryCard.perUnit')} {getPricePeriod()}
                    </span>
                </div>
