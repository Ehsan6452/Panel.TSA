...
import { FiDownload, FiTrash2, FiEye, FiClock, FiUser } from 'react-icons/fi';
import { useLang } from '../../utils/LangHandler';
import './GlobalDocumentCard.css';

export default function GlobalDocumentCard({ document, onDownload, onDelete, onView, onViewVendor }) {
    const { lang } = useLang();
    ...
    return (
        <div className={`global-document-card ${document.status}`}>
